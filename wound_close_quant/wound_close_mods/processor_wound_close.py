...
class ImageProcessor:
    ...
    def __init__(self, filename, im_save_path, img, line_coords, line_length, Ch1, Ch2):
        ...
        with tqdm(total=its, miniters=its/100) as pbar:
            ...
            for channel in range(self.num_channels):
                for frame in range(self.num_frames):
                    ...
                    self.indv_line_values[channel, frame, :, :] = signal.reshape(
                        (self.num_lines, self.bin_num))
